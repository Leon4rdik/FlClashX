...
extension ProfileExtension on Profile {
  ...
  Future<Profile> update({bool shouldSendHeaders = true}) async {
    final proxyUriProfile = proxyUriConverter.tryConvert(url);
    if (proxyUriProfile != null) {
      return copyWith(
        label: label ?? proxyUriProfile.label,
        url: '',
      ).saveFileWithString(proxyUriProfile.content);
    }
